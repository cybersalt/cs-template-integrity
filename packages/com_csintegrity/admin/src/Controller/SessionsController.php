...
final class SessionsController extends BaseController
{
    ...
    public function save(): void
    {
        ...
        try {
            ...
            $app->enqueueMessage(Text::sprintf('COM_CSINTEGRITY_SESSIONS_SAVED', $id), 'success');
            $this->setRedirect(Route::_('index.php?option=com_csintegrity&view=session&id=' . $id, false));
        } catch (Throwable $e) {
            $app->enqueueMessage(Text::sprintf('COM_CSINTEGRITY_SESSIONS_SAVE_ERROR', $e->getMessage()), 'error');
            $this->setRedirect(Route::_('index.php?option=com_csintegrity&view=sessionform', false));
        }
    }
    ...
    public function delete(): void
    {
        ...
        try {
            ...
            $app->enqueueMessage(Text::sprintf('COM_CSINTEGRITY_SESSIONS_DELETED', $count), 'success');
        } catch (Throwable $e) {
            $app->enqueueMessage(Text::sprintf('COM_CSINTEGRITY_SESSIONS_DELETE_ERROR', $e->getMessage()), 'error');
        }
