 ...
 *
 * @var \Cybersalt\Component\Csintegrity\Administrator\View\Actions\HtmlView $this
 */
...
<div class="container-fluid">
    ...
    <?php else : ?>
        <table class="table">
            <thead>
                <tr>
                    <th><?php echo Text::_('COM_CSINTEGRITY_ACTIONS_COL_TIME'); ?></th>
                    <th><?php echo Text::_('COM_CSINTEGRITY_ACTIONS_COL_ACTION'); ?></th>
                    <th><?php echo Text::_('COM_CSINTEGRITY_ACTIONS_COL_SESSION'); ?></th>
                    <th><?php echo Text::_('COM_CSINTEGRITY_ACTIONS_COL_DETAILS'); ?></th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($row->details)) : ?>
                                <small><code class="csintegrity-detail-code"><?php echo $this->escape($row->details); ?></code></small>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
